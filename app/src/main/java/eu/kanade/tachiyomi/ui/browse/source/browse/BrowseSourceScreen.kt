                ...
                Column(
                    ...
                    androidx.compose.animation.AnimatedVisibility(
                        ...
                        Row(
                            ...
                            if (/* SY --> */ state.filterable /* SY <-- */) {//TODO:
                                FilterChip(
                ...
                onMangaLongClick = { manga ->
                    if (state.selectionMode) {
                        scope.launchIO {
                            ...
                            val mangaList = list.map { it.first }
                            state.selection.ifEmpty { screenModel.toggleSelection(manga) }
                            screenModel.toggleRangeSelection(manga, mangaList)
        ...
        when (val dialog = state.dialog) {
            ...
            is BrowseSourceScreenModel.Dialog.ConfirmMangaList -> {
                AlertDialog(
                    ...
                    confirmButton = {
                        Row {
                            ...
                            tachiyomi.presentation.core.components.material.TextButton(
                                onClick = {
                                    scope.launchIO {
                                        val selected=dialog.mangaList
                                        Log.e("TIANY","selected:${selected}")
                    ...
                    text = { Text(text = stringResource(MR.strings.confirm_add_duplicate_manga)) },
                )
            }
